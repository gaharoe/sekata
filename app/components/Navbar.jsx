...
export default function Navbar(){
    ...
    return (
        ...
        <GradualBlur 
            ...
            exponential={true}
        />
        <nav className={`${poppins.className} fixed top-0 left-0 right-0 h-fit flex items-center gap-3 p-3 z-1011 bg-linear-0 from-transparent to-white`}>
        ...
        <section className={`${!slide && "hidden"} ${poppins.className} flex flex-col gap-3 z-1012 p-3 fixed top-15 left-3 w-70 backdrop-blur-lg border rounded-xl border-black/10 bg-white/50`}>
