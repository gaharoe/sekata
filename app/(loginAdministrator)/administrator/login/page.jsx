        ...
        <div className="flex flex-col items-center">
            ...
            <form onSubmit={(e) => handleSubmit(e)} className="w-80 flex flex-col gap-3">
                <div className="relative w-full">
                    ...
                    <label htmlFor="nama" className=" pointer-events-none absolute left-3 top-1/2 px-1 text-sm text-gray-500 transition-all duration-200 peer-placeholder-shown:top-1/2 -translate-y-1/2 peer-placeholder-shown:text-sm peer-focus:top-1/4 peer-focus:text-xs peer-focus:text-blue-500 peer-not-placeholder-shown:top-1/4 peer-not-placeholder-shown:text-xs">
                        Username atau Email
                    </label>
                </div>
